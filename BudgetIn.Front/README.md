...
[![Nuget](https://img.shields.io/nuget/v/SoftwareAteliers.BudgetIn.Front.svg?style=flat&color=2196f3)](https://www.nuget.org/packages/SoftwareAteliers.BudgetIn.Front/)
...
* Install the template from NuGet repository: `dotnet new -i SoftwareAteliers.BudgetIn.Front`
